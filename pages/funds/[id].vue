<template>
  <div class="flex min-h-screen flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <!-- New Fund Form -->
    <div
      class="mb-10 rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm"
    >
      <h2 class="mb-4 text-lg font-semibold text-white">Add New Entry</h2>
      <form
      ...
      >
        <div>
          ...
          <input
            ...
            class="block w-full rounded-md border-0 bg-white/10 px-2 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 transition-all focus:ring-2 focus:ring-inset focus:ring-indigo-500 disabled:opacity-50 sm:text-sm"
          />
        </div>
        <div>
          <label class="mb-1 block text-xs font-medium text-gray-400"
      ...
      <table class="min-w-full divide-y divide-white/10 text-left">
        ...
        <tbody class="divide-y divide-white/5">
          ...
          >
            ...
            <td class="px-6 py-4 text-sm text-gray-300">{{ entry.reason }}</td>
            <td
